...
public class RequestToken implements Token {
    ...
    public RequestToken(String token, String secret) {
        ...
        authorized = false;
        exchanged = false;
        additionalParams = new Hashtable();
    }
    ...
    // Authorized is only for Request Tokens
    ...
    // Exchanged is also only for Request Tokens
    // whether this token has been exchanged for an Access Token
